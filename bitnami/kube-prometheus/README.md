...
| `operator.lifecycleHooks`                                                             | LifecycleHooks for the Prometheus Operator container(s) to automate configuration before or after startup              | `{}`                                  |
...
| `blackboxExporter.lifecycleHooks`                                    | LifecycleHooks for the blackboxExporter container(s) to automate configuration before or after startup            | `{}`                                |
