...
| `query.lifecycleHooks`                                    | LifecycleHooks for the Thanos Query container(s) to automate configuration before or after startup                                      | `{}`                     |
...
| `queryFrontend.lifecycleHooks`                                    | LifecycleHooks for the Thanos Query Frontend container(s) to automate configuration before or after startup                      | `{}`                     |
...
| `bucketweb.lifecycleHooks`                                    | LifecycleHooks for the Thanos Bucket Web container(s) to automate configuration before or after startup                          | `{}`                     |
...
| `compactor.lifecycleHooks`                                    | LifecycleHooks for the Thanos Compactor container(s) to automate configuration before or after startup                           | `{}`                     |
...
| `storegateway.lifecycleHooks`                                    | LifecycleHooks for the Thanos Store Gateway container(s) to automate configuration before or after startup                               | `{}`                        |
...
| `ruler.lifecycleHooks`                                    | LifecycleHooks for the Thanos Ruler container(s) to automate configuration before or after startup                               | `{}`                     |
...
| `receive.lifecycleHooks`                                    | LifecycleHooks for the Thanos Receive container(s) to automate configuration before or after startup                             | `{}`                     |
...
| `receiveDistributor.lifecycleHooks`                                    | LifecycleHooks for the Thanos Receive Distributor container(s) to automate configuration before or after startup            | `{}`             |
