...
| `auth.lifecycleHooks`                                    | LifecycleHooks for the Supabase auth container(s) to automate configuration before or after startup                                               | `{}`                     |
...
| `meta.lifecycleHooks`                                    | LifecycleHooks for the Supabase Postgres Meta container(s) to automate configuration before or after startup                                                      | `{}`                                     |
...
| `realtime.lifecycleHooks`                                    | LifecycleHooks for the Supabase realtime container(s) to automate configuration before or after startup                                             | `{}`                                |
...
| `rest.lifecycleHooks`                                    | LifecycleHooks for the Supabase rest container(s) to automate configuration before or after startup                                                  | `{}`                        |
...
| `storage.lifecycleHooks`                                    | LifecycleHooks for the Supabase storage container(s) to automate configuration before or after startup                                             | `{}`                               |
...
| `studio.lifecycleHooks`                                    | LifecycleHooks for the Supabase studio container(s) to automate configuration before or after startup                                             | `{}`                              |
