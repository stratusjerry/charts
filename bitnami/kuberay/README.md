...
| `operator.lifecycleHooks`                                    | LifecycleHooks for the Kuberay Operator container(s) to automate configuration before or after startup                                                                 | `{}`                               |
...
| `apiserver.lifecycleHooks`                                    | LifecycleHooks for the Kuberay API Server container(s) to automate configuration before or after startup                                                               | `{}`                                |
...
| `cluster.head.lifecycleHooks`                                    | LifecycleHooks for the Ray Cluster Worker (common) container(s) to automate configuration before or after startup        | `{}`             |
...
| `cluster.worker.common.lifecycleHooks`                                    | LifecycleHooks for the Ray Cluster Worker (common) container(s) to automate configuration before or after startup        | `{}`             |
