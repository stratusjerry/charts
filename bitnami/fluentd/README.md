...
| `forwarder.customStartupProbe`                                 | Custom liveness probe for the Fluentd Forwarder                                                                                                                    | `{}`                                                       |
| `forwarder.customLivenessProbe`                                | Custom liveness probe for the Fluentd Forwarder                                                                                                                    | `{}`                                                       |
| `forwarder.customReadinessProbe`                               | Custom readiness probe for the Fluentd Forwarder                                                                                                                   | `{}`                                                       |
...
| `aggregator.customReadinessProbe`                              | Custom readiness probe for the Fluentd Aggregator                                                                                                                  | `{}`                                                       |
...
The new `tls.*` settings will now configure SSL/TLS certificates for the out_forward communications in the Fluentd Forwarder and in_forward in the Fluentd Aggregator, securing the communications between the Forwarder and the Aggregator.
