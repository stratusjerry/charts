...
| `tracking.lifecycleHooks`                                    | LifecycleHooks for the mlflow container(s) to automate configuration before or after startup                                                                           | `{}`             |
...
| `run.lifecycleHooks`                                    | LifecycleHooks for the run container(s) to automate configuration before or after startup       | `{}`             |
