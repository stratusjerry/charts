...
| `dataPlane.lifecycleHooks`                                    | LifecycleHooks for the APISIX container(s) to automate configuration before or after startup                             | `{}`             |
...
| `controlPlane.lifecycleHooks`                                    | LifecycleHooks for the APISIX container(s) to automate configuration before or after startup                             | `{}`             |
...
| `dashboard.lifecycleHooks`                                    | LifecycleHooks for the Dashboard container(s) to automate configuration before or after startup                                                             | `{}`                               |
...
| `ingressController.lifecycleHooks`                                    | LifecycleHooks for the APISIX Ingress Controller container(s) to automate configuration before or after startup                                                      | `{}`                                        |
