...
| `controller.lifecycleHooks`                                    | LifecycleHooks for the MetalLB Controller container(s) to automate configuration before or after startup                                    | `{}`                                 |
...
| `speaker.lifecycleHooks`                                    | LifecycleHooks for the Speaker container(s) to automate configuration before or after startup                                               | `{}`                              |
