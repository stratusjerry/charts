...
| `server.lifecycleHooks`                                    | LifecycleHooks for the Vault Server container(s) to automate configuration before or after startup                                                      | `{}`                    |
...
| `csiProvider.provider.lifecycleHooks`                                    | LifecycleHooks for the CSI Provider container(s) to automate configuration before or after startup                                                            | `{}`                                          |
...
| `csiProvider.agent.lifecycleHooks`                                       | LifecycleHooks for the CSI Provider Agent container(s) to automate configuration before or after startup                                                      | `{}`                                          |
...
| `injector.lifecycleHooks`                                    | LifecycleHooks for the Vault Kubernetes Injector container(s) to automate configuration before or after startup                                                      | `{}`                        |
